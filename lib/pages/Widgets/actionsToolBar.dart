      ...
      children: [
        Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            // _getFollowAction(),
            _getSocialAction(icon: Icons.favorite, title: "6.2m"),
            ...
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(" 9.2m",
                      style:
                          TextStyle(fontSize: 10.0, color: Colors.grey[300])),
                ],
              ),
            ),
            SizedBox(
            ...
            Stack(
              children: [
                Positioned(child: _getMusicPlayerAction()),
              ],
            ),
          ]),
        ),
